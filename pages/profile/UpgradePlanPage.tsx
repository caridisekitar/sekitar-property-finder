    ...
    <div className="flex min-h-screen mb-12 border-t border-gray-200 container mx-auto">
      <SidebarMenu user={user}/>
            ...
            <div className="max-w-6xl mx-auto text-center p-4">
                ...
                {/* Cards */}
                <div className="mt-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8">
                ...
                <div className="relative border-2 border-blue-400 rounded-2xl p-8 shadow-lg">
                    ...
                    <div className="mt-auto pt-8">
                        ...
                        <div className="w-full bg-black text-white py-3 rounded-lg font-medium text-center opacity-50 cursor-not-allowed">
                            Plan sekarang
                        </div>
                        )}
                    </div>
                ...
                {/* PREMIUM PLUS */}
                <div className="border rounded-2xl p-8 shadow-sm h-full">
                    {/* <span className="absolute top-4 right-4 bg-black text-white text-xs px-3 py-1 rounded-full">
                    Recommended for you
                    </span> */}
