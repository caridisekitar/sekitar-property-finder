        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:gap-[200px]">
                ...
                <h4 className="text-[#B3B3B3] text-md md:text-md lg:text-xl text-right font-semibold">
                  Dengan data yang akurat dan filter yang personal, <span className="text-[#96C8E2]">Sekitar</span> hadir untuk bantu kamu menemukan kost terbaik sesuai kebutuhan mu, Di <span className="text-[#96C8E2]">Jakarta</span>, <span className="text-[#96C8E2]">Tangerang</span>, <span className="text-[#96C8E2]">Bali</span>, <span className="text-[#96C8E2]">Jogja</span>, <span className="text-[#96C8E2]">Bandung</span>, <span className="text-[#96C8E2]">Depok</span>.</h4>
                </div>
            </div>
        </div>
    </section>
